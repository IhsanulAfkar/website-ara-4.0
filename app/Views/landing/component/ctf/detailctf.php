...
<section class="relative container mx-auto px-2 mt-20">
    ...
    <div class="flex items-center">
      ...
      <div class="flex-1">
        ...
        <div class="mt-16 flex gap-4 mx-auto">
          <a href="<?= site_url('/register/olimpiade'); ?>"
            class="block text-center bg-blue-500 font-bold text-white w-full py-4 rounded-2xl border-4 border-black drop-shadow-[0_4px_0_rgba(0,0,0,1)]">Daftar</a>
          <a href="https://drive.google.com/file/d/1IoHv5luV8DBL2D0VuPUB9HCcLrTcOMDJ/view?usp=drivesdk" target="_blank"
            class="block text-center bg-yellow-500 font-bold text-black w-full py-4 rounded-2xl border-4 border-black drop-shadow-[0_4px_0_rgba(0,0,0,1)]">Rulebook</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="mx-auto px-2 py-72 bg-[#4C1FAD]">
    ...
    <div class="relative container mx-auto">
      ...
      <p class="text-4xl font-semibold text-center text-white mt-2 md:text-5xl lg:text-6xl"><span
          class="hidden sm:inline">&#129303;</span> Coming Soon <span class="hidden sm:inline">&#129303;</span></p>
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 justify-around mt-24 text-white max-w-xl mx-auto">
        <div>
          <p id="hari"
            class="text-center text-4xl sm:text-6xl font-bold bg-[#339969] p-4 rounded-2xl border-2 border-black drop-shadow-[0_6px_0_rgba(0,0,0,1)]">
            00</p>
  ...
  <section class="container mx-auto px-2 mt-24 sm:mt-48 mb-96">
    ...
    <div class="sm:relative">
      ...
      <p
        class="font-bold text-2xl text-center px-4 py-8 mt-16 bg-[#EFFAFF] border-4 border-black rounded-2xl sm:max-w-[80%] mx-auto">
        Seluruh siswa/i kelas 12 SMA dan Sederajat di Indonesia</p>
    </div>
  </section>
      ...
      <div class="relative border-2 border-black rounded-2xl mt-16 px-4 overflow-hidden bg-white z-10">
        ...
        <div class="flex flex-nowrap overflow-auto py-16 gap-24">
          <div class="flex-1">
            ...
            <div
              class="w-12 h-12 bg-[#F3CA20] rounded-full mx-auto mt-16 border-2 border-black drop-shadow-[0_2px_0_rgba(0,0,0,1)]">
            </div>
          ...
          <div class="flex-1">
            ...
            <div
              class="w-12 h-12 bg-[#339969] rounded-full mx-auto mt-16 border-2 border-black drop-shadow-[0_2px_0_rgba(0,0,0,1)]">
            </div>
        ...
        <div class="grow-0">
          ...
          <div lg:block>
            <div class="mt-16">
              ...
              <a class="block bg-[#339969] w-full py-4 text-2xl text-center font-bold text-white rounded-2xl border-2 border-black"
                href="#"><i class="fa-brands fa-whatsapp"></i> 082113062251</a>
              <a class="mt-8 block bg-[#3AABD7] w-full py-4 text-2xl text-center font-bold text-white rounded-2xl border-2 border-black"
                href="#"><i class="fa-brands fa-line"></i> @hakimfatih</a>
            </div>

            <div class="mt-16">
              <p class="font-bold text-3xl mb-8 text-center	">CP 2 - Wisnuyasha Faizal</p>
              <a class="block bg-[#339969] w-full py-4 text-2xl text-center font-bold text-white rounded-2xl border-2 border-black"
                href="#"><i class="fa-brands fa-whatsapp"></i> 081288350985 </a>
              <a class="mt-8 block bg-[#3AABD7] w-full py-4 text-2xl text-center font-bold text-white rounded-2xl border-2 border-black"
                href="#"><i class="fa-brands fa-line"></i> @wisnuyasha.faiz</a>
            </div>
          </div>
