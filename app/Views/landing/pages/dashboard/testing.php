...
<body class="font-poppins">
    ...
    <div class="flex">
        <div class="border-solid border-r-[1px] border-black h-screen py-5 px-10 w-[400px] relative overflow-hidden">
        ...
        <div class="p-10 mt-6 w-full relative">
            ...
            <div class="mt-14 flex gap-40 mx-auto text-2xl">
