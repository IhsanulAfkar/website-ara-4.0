...
<section class="mx-auto px-2 pt-24 pb-52 bg-[#4C1FAD]">
  ...
  <div class="relative container mx-auto">
    ...
    <p class="text-4xl font-semibold text-center text-white mt-2 md:text-5xl lg:text-6xl"><span class="hidden sm:inline">&#129303;</span> Register <span class="hidden sm:inline">&#129303;</span></p>
