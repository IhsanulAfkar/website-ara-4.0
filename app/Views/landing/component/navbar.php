  ...
  <div class="container px-2 mx-auto flex justify-between items-center">
    ...
    <div class="hidden lg:flex gap-8 font-bold text-lg items-center">
      ...
      <div class="group relative pb-1">
        <a href="#" class="block text-center bg-yellow-500 font-bold py-1 px-4 border-4 border-black">Daftar <i class="fa-solid fa-chevron-down"></i></a>
        <div class="hidden group-hover:block absolute right-0 top-12 bg-yellow-500 rounded-lg">
          <a class="block hover:text-white py-2 px-4" href="#">Olimpiade</a>
...
<div id="menu-list" class="hidden relative">
  <div class="fixed inset-0 bg-white z-50 p-4">
    ...
    <div class="flex flex-col font-bold text-lg text-center">
      ...
      <a id="res_exloit_nav" class="block text-2xl py-2" href="<?= base_url(); ?>/exploit">ExploIT</a>
      <!-- <a id="res_hmit_nav" class="block text-2xl py-2" href="<?= base_url(); ?>/hmit">HMIT</a> -->
    </div>
    <hr class="my-2">
    <div class="flex flex-col font-bold text-lg text-center">
      <a class="block text-2xl py-2" href="<?= base_url(); ?>/ara">Daftar Olimpiade</a>
